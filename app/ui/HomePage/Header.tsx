	...
	return (
		<div className='w-full max-w-content flex h-auto flex-col items-center lg:items-start relative '>
			<div className='flex flex-col gap-4 items-center lg:items-start text-center lg:text-left'>
				...
				<TextGenerateEffect
					words='Hey, I am Jan, a software developer and UI designer from Slovenia. Building reliable software. Enthusiast and developer of ethereum identity. Use AI to maximize output.'
					className='text-lg sm:text-xl xl:w-[90%] w-full sm:w-5/6 md:w-3/4 md:text-2xl font-semibold text-black dark:text-white'
				/>
				<div className='flex mt-4 gap-4 items-center z-20'>
					...
					<button
						...
						className='bg-gray-700 dark:bg-dark-600 h-12 w-36 sm:w-44 text-base font-semibold dark:border-2 dark:border-dark-500 sm:text-lg text-white rounded-md transition-all active:scale-95 dark:hover:bg-dark-500 hover:bg-gray-600'
					>
						Check Projects
					</button>
				</div>
